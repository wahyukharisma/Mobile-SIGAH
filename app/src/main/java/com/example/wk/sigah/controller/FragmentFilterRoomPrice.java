...
public class FragmentFilterRoomPrice extends Fragment{
    ...
    public FragmentFilterRoomPrice(List<RoomFilter> getData) {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.fragment_filterroomprice,container,false);

        myRecycleView=(RecyclerView)view.findViewById(R.id.roomFilterPrice_view);
